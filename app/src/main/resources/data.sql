...
insert into course(id,name,last_updated_date,created_date,is_deleted) values(10002,'Spring in 50 Steps',sysdate(),sysdate(),false);
insert into course(id,name,last_updated_date,created_date,is_deleted) values(10003,'Spring boot in 100 Steps',sysdate(),sysdate(),false);
...
insert into student(id,name,passport_id) values(20002,'Adum',40003);


insert into review(id,rating,description,course_id) values(50001,'FIVE','Great Course',10001);
insert into review(id,rating,description,course_id) values(50002,'FORE','Wonderful Course',10001);
