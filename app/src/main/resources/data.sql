...
insert into course(id,name,last_updated_date,created_date) values(10002,'Spring in 50 Steps',sysdate(),sysdate());
insert into course(id,name,last_updated_date,created_date) values(10003,'Spring boot in 100 Steps',sysdate(),sysdate());
